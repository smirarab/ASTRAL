...
jar cvfm ../mgd.$version.jar ../manifest.text phylonet/util/BitSet.class phylonet/coalescent/DuplicationWeightCounter*.class phylonet/coalescent/*ClusterCollection*class phylonet/coalescent/MGDInference_DP*.class phylonet/coalescent/CannotResolveException.class phylonet/tree/model/sti/STITreeCluster*.class phylonet/coalescent/DeepCoalescencesCounter.class phylonet/coalescent/ComputeMinCostTask.class phylonet/coalescent/STBipartition.class
