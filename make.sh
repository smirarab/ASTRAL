...
javac -source 1.7  -target 1.7 -classpath ../lib/main.jar\;../lib/colt.jar\;../lib/JSAP-2.1.jar\;../lib/JOCL-0.2.0RC.jar phylonet/util/BitSet.java phylonet/coalescent/*.java phylonet/tree/model/sti/STITreeCluster.java phylonet/tree/io/NewickWriter.java
