...
javac -g -source 1.8 -target 1.8 -classpath ../lib/main.jar:../lib/colt.jar:../lib/JSAP-2.1.jar:../lib/jocl-2.0.0.jar phylonet/util/BitSet.java phylonet/coalescent/*.java phylonet/tree/model/sti/STITreeCluster.java phylonet/tree/io/NewickWriter.java
