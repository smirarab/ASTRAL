...
You simply need to download the [zip file](https://github.com/smirarab/ASTRAL/raw/master/Astral.4.10.11.zip) 
...
ASTRAL can be run from any directories. You just need to run `java -jar /path/to/astral/astral.4.10.11.jar`.
Also, you can move `astral.4.10.11.jar` to any location you like and run it from there, but note that you need
