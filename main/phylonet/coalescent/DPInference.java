...
public abstract class DPInference<T> {
	...
	public DPInference(boolean rooted, boolean extrarooted, List<Tree> trees,
...
/*		if (GlobalMaps.taxonNameMap == null && rooted && extraTrees == null && false) {
	...
	abstract ComputeMinCostTask<T> newComputeMinCostTask(DPInference<T> dlInference,
