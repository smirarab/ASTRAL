...
public class CommandLineMP {
	protected static String _version = "5.16.0";
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			Logging.initalize(new ThreadedLogger());
			Logging.log("\n================== ASTRAL ===================== \n");
	...
	private static void runScore( boolean rooted, List<Tree> mainTrees, BufferedWriter outbuffer,
		...
		WQInferenceConsumerMP inference = new WQInferenceConsumerMP(options, mainTrees, new ArrayList<Tree>(), new ArrayList<Tree>());
	...
	private static Tree runOnOneInput(List<Tree> extraTrees,
		...
		WQInferenceConsumerMP inference = 
				new WQInferenceConsumerMP(options, input, extraTrees, toRemoveExtraTrees);
