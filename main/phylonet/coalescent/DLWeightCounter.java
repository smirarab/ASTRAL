...
public class DLWeightCounter extends Counter<STBipartition>{
	...
	public DLWeightCounter(String[] gtTaxa, String[] stTaxa,
			boolean rooted,
	...
	class DPWeightTask implements CalculateWeightTask {
	...
	@Override
	public phylonet.coalescent.Counter.CalculateWeightTask getWeightCalculateTask(
			STBipartition stb) {
