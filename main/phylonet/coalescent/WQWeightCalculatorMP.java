...
class WQWeightCalculatorMP extends WQWeightCalculator{
	...
	class SetWeightCalculator extends WeightCalculatorAlgorithm {
		...
		private void addTripartition(STITreeCluster l_cluster,
			...
			Tripartition trip = new Tripartition((STITreeClusterMP)l_cluster, (STITreeClusterMP)r_cluster, (STITreeClusterMP)remaining);
		...
		void setupGeneTrees(WQInference inference) {
			...
			List<STITreeCluster> treeCompteleClusters = 
					((WQDataCollectionMP)inference.dataCollection).treeAllClusters;
