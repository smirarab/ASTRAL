...
struct cl_Tripartition {
	__local long * cluster1;
	__local long * cluster2;
	__local long * cluster3;
};
...
int bitIntersectionSize(__global long input1[SPECIES_WORD_LENGTH], __local long input2[SPECIES_WORD_LENGTH]) {
	int out = 0;
...
__kernel void calcWeight(
	__read_only image1d_t geneTreesAsInts,
	int geneTreesAsIntsLength,
	__global long* allArray,
	__global long* tripartitions1glob,
	__global long* tripartitions2glob,
	__global long* tripartitions3glob,
	__global long* weightArray,
	__local long* localtrips1,
	__local long* localtrips2,
	__local long* localtrips3	
){
	long weight = 0;
	...
	event_t e[3];
	e[0] = async_work_group_copy(localtrips1, tripartitions1glob, SPECIES_WORD_LENGTH * WORK_GROUP_SIZE, 0);
	e[1] = async_work_group_copy(localtrips2, tripartitions2glob, SPECIES_WORD_LENGTH * WORK_GROUP_SIZE, 0);
	e[2] = async_work_group_copy(localtrips3, tripartitions3glob, SPECIES_WORD_LENGTH * WORK_GROUP_SIZE, 0);
	wait_group_events(3, e);
	
	trip.cluster1 = localtrips1 + idx * SPECIES_WORD_LENGTH;
	trip.cluster2 = localtrips2 + idx * SPECIES_WORD_LENGTH;
	trip.cluster3 = localtrips3 + idx * SPECIES_WORD_LENGTH;
	...
	while(1){
		geneTreesAsInts4Ints = read_imagei(geneTreesAsInts, sampler, counter / 4);
