...
```
java -jar astral.5.7.6.jar -i test_data/song_mammals.424.gene.tre
```

The results will be outputted to the standard output. To save the results in an output file use the `-o` option:

```
java -jar astral.5.7.6.jar -i test_data/song_mammals.424.gene.tre -o test_data/song_mammals.tre
```
...
```
java -jar astral.5.7.6.jar -i test_data/100-simulated-boot
```
...
```
java -jar astral.5.7.6.jar -i test_data/1KP-genetrees.tre -o test_data/1kp.tre 2> test_data/1kp.log
```
...
```
java -jar astral.5.7.6.jar -i test_data/1KP-genetrees-BS10.tre -o test_data/1kp-BS10.tre 2> test_data/1kp-bs10.log
```
...
```
java -jar astral.5.7.6.jar -i test_data/1KP-genetrees.tre -o test_data/1KP-speciestrees-multiind.tre -a test_data/namemap-1kp.txt 2> test_data/1kp-speciestree-multiind.log
```
...
```
java -jar astral.5.7.6.jar -i test_data/song_mammals.424.gene.tre -o test_data/song_mammals.tre 2> song_mammals.log
```
...
```
java -jar astral.5.7.6.jar -q test_data/simulated_14taxon.default.tre -i test_data/simulated_14taxon.gene.tre -o test_data/simulated_scored.tre 2> test_data/simulated_scored.log
```
...
```
java -jar astral.5.7.6.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 2 -o test_data/1kp-scored-t2.tre
```
```
java -jar astral.5.7.6.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 4 -o test_data/1kp-scored-t4.tre
```
```
java -jar astral.5.7.6.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 8 -o test_data/1kp-scored-t8.tre
```
```
java -jar astral.5.7.6.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 10 -o test_data/1kp-scored-t10.tre
```
...
Run:
```
java -jar astral.5.7.6.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 16 -o test_data/1kp-scored-t16.tre
```
...
Then run:
```
java -jar astral.5.7.6.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 32 -o test_data/1kp-scored-t32.tre
```
...
```
java -jar astral.5.7.6.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -c 2 -o test_data/1kp-scored-c2.tre
```

```
java -jar astral.5.7.6.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -c 0.001 -o test_data/1kp-scored-cs.tre
``` 
...
```
java -jar ../astral.5.7.6.jar -i song_mammals.424.gene.tre -b bs-files -o song_mammals.bootstrapped.astral.tre
```
...
```
java -jar ../astral.5.7.6.jar -i song_mammals.424.gene.tre -b bs-files -r 150 -o song_mammals.bootstrapped.150.astral.tre
```
...
```
java -jar ../astral.5.7.6.jar -i song_mammals.424.gene.tre -b bs-files -g -r 100 -o song_mammals.bootstrapped.gs.astral.tre
```
...
```
java -jar ../astral.5.7.6.jar -i song_mammals.424.gene.tre --gene-only -o song_mammals.bootstrapped.go.astral.tre
```
...
```
java -jar astral.5.7.6.jar -i test_data/song_primates.424.gene.tre -o test_data/song_primates.424.exact.tre -x
```
...
```
java -jar astral.5.7.6.jar -i test_data/song_primates.424.gene.tre -o test_data/song_primates.424.default.tre
```
...
```
java -jar astral.5.7.6.jar -i test_data/simulated_14taxon.gene.tre -o test_data/simulated_14taxon.default.tre
```

and then

```
java -jar astral.5.7.6.jar -i test_data/simulated_14taxon.gene.tre -o test_data/simulated_14taxon.exact.tre -x
```
...
```
java -jar astral.5.7.6.jar -i test_data/simulated_primates_5X.10.gene.tre -o test_data/simulated_primates_5X.10.species.tre -e test_data/simulated_primates_5X.10.bootstrap.gene.tre
```
...
```
java -Xmx3000M -jar astral.5.7.6.jar -i in.tree
```
...
~~~bash
java -jar astral.5.7.6.jar -i gt.tre  -a mapping.txt   -o gt-renamed.tre -R > newmapping.txt
~~~
...
~~~bash 
java -jar astral.5.7.6.jar -i gt-renamed.tre  -a newmapping.txt   -o astral.tre 
~~~
