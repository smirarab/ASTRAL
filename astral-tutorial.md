...
* Once the terminal opens, go the location where you have downloaded the software (e.g. using `cd ~/astral-home/`),
	* Note that you do not actually need to be in directory to be able to run ASTRAL but if you are in a different directory, you need to change all instances of `./lib/` and `astral.5.15.2.jar` to the correct path (e.g., `~/astral-home/lib/` and  `~/astral-home/astral.5.15.2.jar`.
...
```
  java -Djava.library.path=./lib/ -jar astral.5.15.2.jar
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/song_mammals.424.gene.tre
```

The results will be outputted to the standard output. To save the results in an output file use the `-o` option:

```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/song_mammals.424.gene.tre -o test_data/song_mammals.tre
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/100-simulated-boot
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/1KP-genetrees.tre -o test_data/1kp.tre 2> test_data/1kp.log
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/1KP-genetrees-BS10.tre -o test_data/1kp-BS10.tre 2> test_data/1kp-bs10.log
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/song_mammals.424.gene.tre -o test_data/song_mammals.tre 2> song_mammals.log
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -q test_data/simulated_14taxon.default.tre -i test_data/simulated_14taxon.gene.tre -o test_data/simulated_scored.tre 2> test_data/simulated_scored.log
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 2 -o test_data/1kp-scored-t2.tre
```
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 4 -o test_data/1kp-scored-t4.tre
```
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 8 -o test_data/1kp-scored-t8.tre
```
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 10 -o test_data/1kp-scored-t8.tre
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -c 2 -o test_data/1kp-scored-c2.tre
```

```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -c 0.001 -o test_data/1kp-scored-cs.tre
``` 
...
```
java -Djava.library.path=./lib/  -jar ../astral.5.15.2.jar -i song_mammals.424.gene.tre -b bs-files -o song_mammals.bootstrapped.astral.tre
```
...
```
java -Djava.library.path=./lib/ -jar ../astral.5.15.2.jar -i song_mammals.424.gene.tre -b bs-files -r 150 -o song_mammals.bootstrapped.150.astral.tre
```
...
```
java -Djava.library.path=./lib/ -jar ../astral.5.15.2.jar -i song_mammals.424.gene.tre -b bs-files -g -r 100 -o song_mammals.bootstrapped.gs.astral.tre
```
...
```
java -Djava.library.path=./lib/ -jar ../astral.5.15.2.jar -i song_mammals.424.gene.tre --gene-only -o song_mammals.bootstrapped.go.astral.tre
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/song_primates.424.gene.tre -o test_data/song_primates.424.exact.tre -x
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/song_primates.424.gene.tre -o test_data/song_primates.424.default.tre
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/simulated_14taxon.gene.tre -o test_data/simulated_14taxon.default.tre
```

and then

```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/simulated_14taxon.gene.tre -o test_data/simulated_14taxon.exact.tre -x
```
...
```
java -Djava.library.path=./lib/ -jar astral.5.15.2.jar -i test_data/simulated_primates_5X.10.gene.tre -o test_data/simulated_primates_5X.10.species.tre -e test_data/simulated_primates_5X.10.bootstrap.gene.tre
```
...
```
java -Xmx3000M -jar astral.5.15.2.jar -i in.tree
```
