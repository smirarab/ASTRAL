...
g++ -std=c++11 -I"$DIR" -I"$SUBDIR" -I"$DIR2" -I"$SUBDIR2" -I"$DIR3" -I"$SUBDIR3" -I"$DIR4" -I"$SUBDIR4" -march=native -Ofast -fPIC -o lib/${LIBNAME} -shared main/phylonet_coalescent_Polytree_PTNative.cpp || mv lib/${LIBNAME}.old lib/${LIBNAME} || echo "Native library not compiled and default version not found."
